"""
Model inputs for intercomparisson test A6. 
"""
...
V_cr = FunctionSpace(mesh, FiniteElement("Discontinuous Lagrange Trace", "triangle", 0))

# Write inputs to a hdf5 file
f = HDF5File(mesh.mpi_comm(), out_dir + "inputs_A6.hdf5", 'w')
# Write the mesh to a file
f.write(mesh, "mesh")

# Melt
m = interpolate(Constant(5.79e-07), V_cg)
f.write(m, "m_0")
